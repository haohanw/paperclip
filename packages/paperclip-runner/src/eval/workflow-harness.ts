...
import { runRunnerEvalMatrix, type RunnerEvalCandidate } from "./matrix.js";
...
export const DETERMINISTIC_RUNNER_WORKFLOW_CANDIDATES: readonly RunnerEvalCandidate<DeterministicRunnerWorkflowCandidate>[] = Object.freeze([
...
export async function runDeterministicRunnerWorkflowMatrix(
  ...
  const results = await runRunnerEvalMatrix({
